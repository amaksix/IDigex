...
function initProjectAnimations(root = document) {
  const projects = root.querySelectorAll(".tp-project-5-2-area");

  projects.forEach((item) => {
    // scoped querySelector instead of jQuery
    const img1 = item.querySelector(".tp-project-5-2-img-1");
    const img2 = item.querySelector(".tp-project-5-2-img-2");
